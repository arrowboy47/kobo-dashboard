...
-- ==== CONFIG (edit these) ====
local URL = "http://104.168.7.21:3333/today.png" -- URL to fetch the PNG from. If using a local server, use the device's LAN IP. If using Docker, you might not need to change anything
